...
//		awayTeamContainer = new TeamContainerPanel(teamContainerWidth, teamContainerHeight);
//		homeTeamContainer = new TeamContainerPanel(teamContainerWidth, teamContainerHeight);
//		
...
//		upperContainer.setPreferredSize(new Dimension(upperContainerWidth, upperContainerHeight));
...
//		}
//		try {
//			Font font = Font.createFont(Font.TRUETYPE_FONT, new File("res/fonts/DejaVuSans.ttf"));
